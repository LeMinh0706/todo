...
func (x *StreamServerRequest) GetIntervalSeconds() int32 {
	if x != nil {
...
func (x *StreamServerResponse) GetCurrentTime() *timestamppb.Timestamp {
	if x != nil {
...
const file_proto_streaming_proto_rawDesc = "" +
	"\n" +
	"\x15proto/streaming.proto\x12\tstreaming\x1a\x1fgoogle/protobuf/timestamp.proto\"@\n" +
	"\x13StreamServerRequest\x12)\n" +
	"\x10interval_seconds\x18\x01 \x01(\x05R\x0fintervalSeconds\"U\n" +
	"\x14StreamServerResponse\x12=\n" +
	"\fcurrent_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\vcurrentTime2i\n" +
	"\x10StreamingService\x12U\n" +
	"\x10StreamServerTime\x12\x1e.streaming.StreamServerRequest\x1a\x1f.streaming.StreamServerResponse0\x01B\"Z github.com/LeMinh0706/todo/protob\x06proto3"
...
var file_proto_streaming_proto_goTypes = []any{
	(*StreamServerRequest)(nil),   // 0: streaming.StreamServerRequest
	(*StreamServerResponse)(nil),  // 1: streaming.StreamServerResponse
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_proto_streaming_proto_depIdxs = []int32{
	2, // 0: streaming.StreamServerResponse.current_time:type_name -> google.protobuf.Timestamp
	0, // 1: streaming.StreamingService.StreamServerTime:input_type -> streaming.StreamServerRequest
	1, // 2: streaming.StreamingService.StreamServerTime:output_type -> streaming.StreamServerResponse
