...
type StreamingServiceClient interface {
	StreamServerTime(ctx context.Context, in *StreamServerRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StreamServerResponse], error)
}
...
func (c *streamingServiceClient) StreamServerTime(ctx context.Context, in *StreamServerRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StreamServerResponse], error) {
	...
	x := &grpc.GenericClientStream[StreamServerRequest, StreamServerResponse]{ClientStream: stream}
...
type StreamingService_StreamServerTimeClient = grpc.ServerStreamingClient[StreamServerResponse]
...
type StreamingServiceServer interface {
	StreamServerTime(*StreamServerRequest, grpc.ServerStreamingServer[StreamServerResponse]) error
...
func (UnimplementedStreamingServiceServer) StreamServerTime(*StreamServerRequest, grpc.ServerStreamingServer[StreamServerResponse]) error {
...
func _StreamingService_StreamServerTime_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StreamingServiceServer).StreamServerTime(m, &grpc.GenericServerStream[StreamServerRequest, StreamServerResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StreamingService_StreamServerTimeServer = grpc.ServerStreamingServer[StreamServerResponse]
